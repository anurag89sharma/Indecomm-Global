...
On the terminal go to the directory where solution1.py and input.txt are present
Write this command -- python solution1.py input.txt
Sample output --
...
Test Case 1: Passed 
.Test Case 2: Passed .Could not read file: no-file-present.txt 
Test Case 3: Passed 
.Test Case 4: Passed .File is malformed 
Test Case 5: Passed
.
